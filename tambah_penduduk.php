...
<body>
        <div class="au-card" style=" color: white; box-shadow: 4px 2px 4px;">
    <!-- Left Panel -->
                            ...
                            <div class="modal-body">
                                <form action="s_penduduk.php" method="post" name="form" id="form" onSubmit="return validasi(this)" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="almt" name="almt"  placeholder="Contoh : Kp. Pulo, RT/RW.011/005" class="form-control"><small class="form-text text-muted">Contoh : Kp. Pulo, RT/RW.011/005</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="hp" class=" form-control-label">No. HP</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="hp" name="hp"  placeholder="No. HP" class="form-control"><small class="form-text text-muted">Contoh : 081219168380</small></div>
                                    </div>
                                    <div class="row form-group">
