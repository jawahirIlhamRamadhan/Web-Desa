...
<table width="800" align="center" border="0" cellspacing="1" cellpadding="4" class="table-print">
  <tr>
   ...
   <td colspan="3" align="center"><hr><font size=2 color="black"><i>Sekretariat : <?php echo $rd['kantor'];?></i><hr size="3"></td>
    ...
    <tr>
    <td colspan="3" align="center"><strong><font size=4 color="black"><u><?php echo strtoupper($r['ns']); ?> </u></font></a>
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">Adalah benar Penduduk Desa <?php echo $r['desa'];?> Kecamatan <?php echo $r['kec'];?> dan benar berkelakuan baik serta tidak pernah terlibat dalam kasus Pidana maupun Perdata serta tidak pernah terlibat kasus kenakalan Remaja ataupun pemakaian obat-obatan terlarang (Narkoba). Surat Keterangan ini kami berikan kepadanya untuk mengurus SKCK</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
