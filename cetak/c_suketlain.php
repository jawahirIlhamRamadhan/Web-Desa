...
<table width="800" align="center" border="0" cellspacing="1" cellpadding="4" class="table-print">
  <tr>
   ...
   <td colspan="3" align="center"><hr><font size=2 color="black"><i>Sekretariat : <?php echo $rd['kantor'];?></i><hr size="3"></td>
    ...
    <tr>
    <td colspan="3" align="center"><strong><font size=4 color="black"><u><?php echo strtoupper($dt[0]); ?> </u></font></a>
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td>Nama</td><td>:</td><td><?php echo $dt[2];?></td>
  </tr>
  <tr>
    <td>NIK</td><td>:</td><td><?php echo $dt[1];?></td>
  </tr>
    <tr>
    <td>Jenis Kelamin</td><td>:</td><td><?php echo $dt[3];?></td>
  </tr>
  <tr>
    <td>Tmp. & Tgl. Lahir</td><td>:</td><td><?php echo $dt[4];?>, <?php echo $dt[5];?> </td>
  </tr>
    <tr>
    <td>Agama</td><td>:</td><td><?php echo $dt[6];?></td>
  </tr>
  <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[7];?> Desa <?php echo $r['desa'];?></td>
  </tr>
  <tr>
