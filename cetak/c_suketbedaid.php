...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <td colspan="3" align="justify">Yang bertanda tangan dibawah ini Kepala Desa <?php echo $rd['desa'];?> Kecamatan <?php echo $rd['kec'];?> Kabupaten <?php echo $rd['kab'];?>, menerangkan bahwa Identitas Warga Desa <?php echo $rd['desa'];?>  dibawah ini terdapat perbedaan antara <?php echo $dt[7];?>  dengan <?php echo $dt[15];?>  sebagai berikut :</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
    <tr>
    <td colspan="3">IDENTITAS DI  <?php echo $dt[7];?> :</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[6];?> Desa <?php echo $r['desa'];?></td>
  </tr>
  <tr>
...
<tr>
    <td colspan="3">&nbsp;</td>
      ...
      <tr>
    <td colspan="3">IDENTITAS DI <?php echo $dt[15];?>  :</td>
  </tr>
    <tr>
    <td>Nama </td><td>:</td><td><?php echo $dt[9];?></td>
  </tr>
  <tr>
    <td>NIK</td><td>:</td><td><?php echo $dt[8];?></td>
  </tr>
    <tr>
    <td>Tmp.&Tgl. Lahir</td><td>:</td><td><?php echo $dt[11];?>, &nbsp; <?php echo $dt[12];?></td>
  </tr>
    <tr>
    <td>Agama</td><td>:</td><td><?php echo $dt[13];?></td>
  </tr>
    <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[14];?> Desa <?php echo $r['desa'];?></td>
  </tr>
  <tr>
    <td></td><td></td><td>Kec. <?php echo $r['kec'];?> Kab. <?php echo $r['kab'];?></td>
  </tr>
