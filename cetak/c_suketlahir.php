...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td>Nama</td><td>:</td><td><?php echo $dt[15];?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[20];?> Desa <?php echo $r['desa'];?></td>
  </tr>
  <tr>
...
<table align="center" class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
    ...
    <tr>
    <td colspan="4">Nama tersebut diatas adalah Benar Anak dari Pasangan sebagai berikut :</td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Alamat</td><td>:</td><td><?php echo $dt[6];?> Desa <?php echo $r['desa'];?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Alamat</td><td>:</td><td><?php echo $dt[13];?> Desa <?php echo $r['desa'];?></td>
  </tr>
  <tr>
    <td></td><td></td><td></td><td>Kec. <?php echo $r['kec'];?> Kab. <?php echo $r['kab'];?></td>
  </tr>
