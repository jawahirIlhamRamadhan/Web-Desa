...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">Nama tersebut diatas adalah Warga Desa <?php echo $rd['desa'];?> yang telah meninggal dunia dan di <b>Kuburkan di Pemakaman <?php echo $dt[8]; ?> Desa <?php echo $rd['desa'];?>  pada tanggal <?php echo $dt[7]; ?></b>.</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
