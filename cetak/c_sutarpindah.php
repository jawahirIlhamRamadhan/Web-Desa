...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td>Nama Lengkap</td><td>:</td><td><?php echo $r['nama'];?></td>
  </tr>
      <tr>
    <td>No. Induk Kependudukan</td><td>:</td><td><?php echo $r['nik'];?></td>
  </tr>
  <tr>
    <td>No. Kartu Keluarga</td><td>:</td><td><?php echo $r['nkk'];?></td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <tr>
    <td>Tujuan Pindah</td><td>:</td><td><?php echo $dt[2];?></td>
  </tr>
      <tr>
    <td>Jumlah Keluarga yang Ikut</td><td>:</td><td><?php echo $dt[3];?> </td>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">Adapun Permohonan Pindah Penduduk WNI yang bersangkutan sebagaimana terlampir.</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
    <tr>
    <td colspan="3">Demikian Surat Pengantar Pindah ini dibuat agar digunakan sebagaimana mestinya. </td>
  </tr>
