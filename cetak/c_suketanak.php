...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td>Alamat</td><td>:</td><td><?php echo  $dt[20];?> Desa <?php echo  $rd['desa'];?></td>
  </tr>
  <tr>
...
<table align="center" class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td></td><td>Alamat</td><td>:</td><td><?php echo  $dt[6];?> Desa <?php echo  $rd['desa'];?></td>
  </tr>
  <tr>
    <td></td><td></td><td></td><td>Kec. <?php echo  $rd['kec'];?> Kab. <?php echo  $rd['kab'];?></td>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Alamat</td><td>:</td><td><?php echo  $dt[13];?> Desa <?php echo  $rd['desa'];?></td>
  </tr>
  <tr>
    <td></td><td></td><td></td><td>Kec. <?php echo  $rd['kec'];?> Kab. <?php echo  $rd['kab'];?></td>
  </tr>
