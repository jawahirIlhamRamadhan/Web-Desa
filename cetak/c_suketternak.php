...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <tr>
    <td>Nama Ternak</td><td>:</td><td><b><?php echo $dt[0];?></b></td>
  </tr>
    <tr>
    <td>Jenis Ternak</td><td>:</td><td><?php echo $dt[1];?></td>
  </tr>
    <tr>
    <td>Ciri - ciri Ternak</td><td>:</td><td><?php echo $dt[2];?></td>
  </tr>
    <tr>
    <td>Nama Pemilik Ternak</td><td>:</td><td><?php echo $dt[3];?></td>
  </tr>
    <tr>
    <td>Asal Ternak/dari</td><td>:</td><td><?php echo $dt[4];?></td>
  </tr>
    <tr>
    <td>Tujuan Ternak/dikirim ke</td><td>:</td><td><?php echo $dt[5];?></td>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">Hewan Ternak tersebut diatas adalah benar milik : </td>
  </tr>
  <tr>
