...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">warga tersebut diatas adalah benar warga Desa <?php echo $rd['desa'];?> yang masuk dalam kategori Keluarga Tidak Mampu dan Surat Keterangan Tidak Mampu ini dipergunakan untuk :</td>
  </tr>
  <td colspan="3" align="center"><br><b><?php echo strtoupper($dt[2]);?></b></td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
