...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">Nama tersebut adalah benar Warga Desa <?php echo $rd['desa'];?> yang memiliki Usaha sebagai berikut :</td>
  </tr>
    <tr>
    <td>Jenis/Bidang Usaha</td><td>:</td><td><?php echo $detail[0];?></td>
  </tr>
      <tr>
    <td>Berjalan Sejak</td><td>:</td><td><?php echo $detail[1];?></td>
  </tr>
      <tr>
    <td>Alamat / Lokasi Usaha</td><td>:</td><td><?php echo $detail[2];?></td>
  </tr>
