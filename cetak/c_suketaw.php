...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_ahliwaris.*, t_detailsurat.*, t_penduduk.* from t_jenissurat, t_datasurat, t_ahliwaris, t_detailsurat, t_penduduk
WHERE t_detailsurat.kode='$kodesurat' AND t_detailsurat.nik=t_penduduk.nik");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <table align="center" class="table" width="90%" border="1" cellspacing="4" cellpadding="6">
    ...
    <?php
    $query = mysqli_query ($con, "SELECT  * from t_ahliwaris WHERE t_ahliwaris.kodeaw='$kodesurat'");
    $no=1;
