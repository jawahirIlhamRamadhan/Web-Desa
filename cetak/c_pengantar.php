...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
        <td></td><td></td><td><?php echo $dt[3];?></td>
  </tr>
  <tr>
        <td></td><td></td><td>Di -</td></tr>
  <tr>
        <td></td><td></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u><?php echo $dt[4];?></u></td>
  </tr>
    <tr>
    <td colspan="4">&nbsp;</td>
  </tr>   
  ...
  <tr>
    <td></td><td></td><td colspan="3" align="justify">Menindaklanjuti surat <?php echo $dt[2];?>, berikut ini Kami sampaikan <?php echo $dt[0];?> sebagaimana terlampir. </td>
  </tr>
    <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
