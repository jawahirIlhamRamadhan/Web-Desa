...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">Nama tersebut diatas adalah Warga Desa <?php echo $rd['desa'];?> yang telah Berdomisili / tinggal menetap secara berturut - turut sejak <?php echo $dt[0]; ?> sampai dengan sekarang.</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
