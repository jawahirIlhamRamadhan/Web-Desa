...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <td colspan="3">&nbsp;</td>
      ...
      <tr>
    <td>Tujuan</td><td>:</td><td><?php echo $dt[0];?></td>
  </tr>
    <tr>
    <td>Dalam Rangka / Kegiatan</td><td>:</td><td><?php echo $dt[1];?></td>
  </tr>
    <tr>
    <td>Tanggal Keberangkatan</td><td>:</td><td><?php echo $dt[2];?></td>
  </tr>
    <tr>
    <td>Barang yang dibawa</td><td>:</td><td><?php echo $dt[3];?></td>
  </tr>
