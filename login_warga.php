...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="col-lg-12 text-center">
            ...
            <h3 style="color: white; padding: 20px; text-align: center;text-shadow: -2px 2px rgb(110,112,145);">Silahkan Masuk untuk bisa membuat & mencetak surat sendiri</h3>
        </div>
            <div class="container">
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-form">
                            <form action="login_warga_act.php" method="post">
                                <div class="form-group">
                                    <label>NIK</label>
                                    <input  type="text" id="nik" name="nik" class="form-control" onkeyup="isinik()" placeholder="Nomor Induk Kependudukan">
                                </div>
                                <div class="form-group">
                                    <label>Nama</label>
