                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM t_detailsurat, t_penduduk WHERE t_detailsurat.kodejenis='JS001' AND t_penduduk.nik=t_detailsurat.nik ORDER BY t_detailsurat.id DESC ");
                            $no=1;
