                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php
                                ...
                                <form action="act/s_suketdomisili.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_detailsurat.*, t_penduduk.* FROM t_detailsurat, t_penduduk WHERE t_detailsurat.kodejenis='JS015' AND t_detailsurat.nik=t_penduduk.nik ORDER BY t_detailsurat.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="hapus/h_suketdomisili.php?kode=<?php echo $data['kode'];?>" class="btn"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
