...
mysqli_query($con, "INSERT INTO t_detailsurat (kode, kodejenis, nmsurat, no, nik, nama, detail, tanggal, ttd, qrcode, id_ptg) values('$kode','$kodejenis','$nmsurat','$nosur','$nik','$nama', '$sejak','".date('Y-m-d')."','$kades','".$nama_qr.".png','$idstf')");

echo "<script>alert('Surat Keterangan Domisili berhasil dibuat!'); window.location = '../cetak/c_suketdomisili.php?kode=$kode'</script>"; 
}
?>
