...
<body class="animsition">
    ...
    <section class="p-t-20 p-b-20" style="background: url(assets/pattern/purty_wood.png) repeat;">
        <div class="col-lg-12 text-center">
            <h1 style="color: white; padding: 10px;text-shadow: -2px 2px rgb(110,112,145);">LAYANAN SURAT DESA ONLINE</h1>
            <h3 style="color: white; padding: 5px; text-align: center;text-shadow: -2px 2px rgb(110,112,145);">Silahkan lengkapi form berikut</h3>
        </div>
            <div class="container">
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-form">
                            <form action="act/s_permohonan.php" method="post" enctype="multipart/form-data" class="form-control">
                                <div class="form-group">
                                    <label>NIK</label>
                                    <input type="text" id="nik" name="nik" onkeyup="isinik()" class="form-control"  placeholder="Nomor Induk Kependudukan">
                                </div>
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="text" id="nama" name="nama" class="form-control"  placeholder="Nomor Induk Kependudukan">
                                </div>
                                <div class="form-group">
                                    <label>Jenis Surat</label>
                                    <select id="nmsurat" name="nmsurat" onchange="isiredaksi()" class="form-control">
                                        <option value="">Pilih Jenis atau Nama Surat</option>
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM t_jenissurat ORDER BY id ASC ");
                                ...
                                <button class="au-btn au-btn--block au-btn--green m-b-0" type="submit" name="simpan">Kirim Permohonan</button>
                            </form>
                            <div class="form-group">
                                <p>
                                    NIK Tidak terdaftar
