                            ...
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea id="dasar" rows="3" name="dasar"   class="form-control"><?php echo $dt[2]; ?></textarea> <small class="form-text text-muted">Contoh : Surat Camat Cikupa Nomor : 123, Tanggal 12 Mei 2023, Perihal Laporan Penduduk Bulan Mei 2023</small></div>
                                    </div>
                                    <hr>
