...
?>
        ...
        <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">EDIT SURAT KETERANGAN BEPERGIAN
                            </h1>
                        </div>
 ...
 <?php
            ...
            ?>
                                ...
                                <form action="update/u_suketbepergian.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <hr>
                                   <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tujuan" name="tujuan" class="form-control"  value="<?php echo $dt[0]; ?>" ><small class="form-text text-muted">Contoh : Kota Jakarta</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="keg" class=" form-control-label">Dalam rangka / Kegiatan </label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="keg" name="keg" class="form-control"  value="<?php echo $dt[1]; ?>" ><small class="form-text text-muted">Contoh : Bekerja</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tgl" class=" form-control-label">Tanggal Keberangkatan</label></div>
                                        <div class="col-12 col-md-4"><input type="text" id="tgl" name="tgl" class="form-control"  value="<?php echo $dt[2]; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="brg" class=" form-control-label">Barang yang dibawa</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="brg" name="brg" class="form-control"  value="<?php echo $dt[3]; ?>" ><small class="form-text text-muted">Contoh : Pakaian ganti</small></div>
                                    </div>
