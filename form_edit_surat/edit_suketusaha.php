    ...
    <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">EDIT SURAT KETERANGAN USAHA
                            </h1>
                        </div>
...
<div class="card-body card-block">
            ...
            ?>  
                    <form action="update/u_suketusaha.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <hr>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="nik" name="nik" class="form-control" maxlength="16"  value="<?php echo $row ['nik']; ?>"  ></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="jnusaha" name="jnusaha" value="<?php echo $dt[0]; ?>"   class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="mulaiusaha" class=" form-control-label">Berjalan Sejak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="mulaiusaha" name="mulaiusaha" value="<?php echo $dt[1]; ?>"   class="form-control"></div>
                                    </div>
                                                                        <div class="row form-group">
                                        <div class="col col-md-3"><label for="lokusaha" class=" form-control-label">Alamat / Lokasi Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="lokusaha" name="lokusaha" value="<?php echo $dt[2]; ?>"   class="form-control"></div>
                                    </div>
                                    <hr>
                                    <div class="row form-group">
