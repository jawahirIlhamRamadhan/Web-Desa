    ...
    <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">EDIT SURAT KETERANGAN TEMPAT USAHA
                            </h1>
                        </div>
...
<div class="card-body card-block">
    <?php
            ...
            ?>
                                <form action="update/u_sukettmpusaha.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <hr>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="nmusaha" name="nmusaha" class="form-control"  value="<?php echo $dt[0];?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="bdgusaha" class=" form-control-label">Bidang Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="bdgusaha" name="bdgusaha" class="form-control"  value="<?php echo $dt[1]; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="thnbediri" class=" form-control-label">Tahun Berdiri</label></div>
                                        <div class="col-12 col-md-3"><input type="text" id="thnberdiri" name="thnberdiri" class="form-control"  value="<?php echo $dt[2]; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="pemilikusaha" class=" form-control-label">Pemilik Usaha</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="pemilikusaha" name="pemilikusaha" class="form-control"  value="<?php echo $dt[3]; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jmlpekerja" class=" form-control-label">Jumlah Pekerja</label></div>
                                        <div class="col-12 col-md-3"><input type="number" id="jmlpekerja" name="jmlpekerja" class="form-control"  value="<?php echo $dt[4]; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="izinusaha" class=" form-control-label">Izin Usaha yang di Miliki</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="izinusaha" name="izinusaha" class="form-control"  value="<?php echo $dt[5]; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="alamtusaha" class=" form-control-label">Alamat Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="alamatusaha" name="alamatusaha" class="form-control"  value="<?php echo $dt[6]; ?>"></div>
                                    </div>
                                <hr>
