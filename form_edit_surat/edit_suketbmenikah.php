        ...
        <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">EDIT SURAT KETERANGAN BELUM PERNAH MENIKAH
                            </h1>
                        </div>
...
<?php
            ...
            ?>
                    <form action="update/u_suketbmenikah.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
