        ...
        <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">EDIT SURAT KETERANGAN MENIKAH
                            </h1>
                        </div>
...
<?php
            ...
            ?> 
                    <form action="update/u_suketmenikah.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="prov" name="prov" value="<?php echo $dt[7];?>" class="form-control"><small class="form-text text-muted">Contoh : Banten</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="kab" class=" form-control-label">Kabupaten/Kota</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="kab" name="kab" value="<?php echo $dt[8];?>" class="form-control"><small class="form-text text-muted">Contoh : Tangerang</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="kec" class=" form-control-label">Kecamatan</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="kec" name="kec" value="<?php echo $dt[9];?>" class="form-control"><small class="form-text text-muted">Contoh : Cikupa</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="desa" class=" form-control-label">Desa</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="desa" name="desa" value="<?php echo $dt[10];?>" class="form-control"><small class="form-text text-muted">Contoh : Bitung Jaya</small></div>
                                    </div>

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="alamat" class=" form-control-label">Alamat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="alamat" name="alamat"  value="<?php echo $dt[6];?>"class="form-control"><small class="form-text text-muted">Contoh : Kp. Pulo, RT/RW.011/005</small></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="niki" name="niki" onkeyup="isiniki()" class="form-control" maxlength="16"  value="<?php echo $dt[11];?>"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="namai" class=" form-control-label">Nama</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="namai" name="namai" value="<?php echo $dt[12];?>"class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jki" class=" form-control-label">Jenis Kelamin</label></div>
                                        <div class="col-12 col-md-4">
                                            <select name="jki" id="jki" class="form-control">
                                                <option value="<?php echo $dt[13];?>"><?php echo $dt[13];?></option>
                                                <option value="Laki-laki">Laki-laki</option>
                                                <option value="Perempuan">Perempuan</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tmp_lahiri" name="tmp_lahiri" value="<?php echo $dt[14];?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tgl_lahiri" class=" form-control-label">Tanggal Lahir</label></div>
                                        <div class="col-12 col-md-4"><input type="text" id="tgl_lahiri" name="tgl_lahiri" value="<?php echo $dt[15];?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4">
                                            <select name="agamai" id="agamai" class="form-control">
                                                <option value="<?php echo $dt[16];?>" ><?php echo $dt[16];?></option>
                                                <option value="Islam">Islam</option>
                                                <option value="Katholik">Katholik</option>
                                                <option value="Protestan">Protestan</option>
                                                <option value="Hindu">Hindu</option>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="provi" name="provi"value="<?php echo $dt[18];?>" class="form-control"><small class="form-text text-muted">Contoh : Banten</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="kabi" class=" form-control-label">Kabupaten/Kota</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="kabi" name="kabi" value="<?php echo $dt[19];?>" class="form-control"><small class="form-text text-muted">Contoh : Tangerang</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="keci" class=" form-control-label">Kecamatan</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="keci" name="keci" value="<?php echo $dt[20];?>" class="form-control"><small class="form-text text-muted">Contoh : Cikupa</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="desai" class=" form-control-label">Desa</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="desai" name="desai" value="<?php echo $dt[21];?>" class="form-control"><small class="form-text text-muted">Contoh : Bitung Jaya</small></div>
                                    </div>

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="alamati" class=" form-control-label">Alamat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="alamati" name="alamati"  value="<?php echo $dt[17];?>" class="form-control"><small class="form-text text-muted">Contoh : Kp. Pulo, RT/RW.011/005</small></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="tgl_nikah" name="tgl_nikah" class="form-control"  value="<?php echo $dt[22];?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="secara" class=" form-control-label">Menikah Secara</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="secara" name="secara" class="form-control" value="<?php echo $dt[23];?>" ></div>
                                    </div>

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="mahar" class=" form-control-label">Mahar Pernikahan</label></div>
                                        <div class="col-12 col-md-4"><input type="text" id="mahar" name="mahar" class="form-control" value="<?php echo $dt[24];?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="saksi1" class=" form-control-label">Saksi 1</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="saksi1" name="saksi1" class="form-control" value="<?php echo $dt[25];?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="saksi2" class=" form-control-label">Saksi 2</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="saksi2" name="saksi2" class="form-control" value="<?php echo $dt[26];?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="alasan" class=" form-control-label">Alasan Surat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="alasan" name="alasan" class="form-control" value="<?php echo $dt[27];?>" ><small class="form-text text-muted">Contoh : Menikah Siri atau Buku Nikah Dalam Proses, dll.</small></div>
                                    </div>
