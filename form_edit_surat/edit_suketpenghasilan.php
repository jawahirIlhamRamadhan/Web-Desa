        ...
        <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">EDIT SURAT KETERANGAN PENGHASILAN
                            </h1>
                        </div>
...
<?php
            ...
            ?> 
                    <form action="update/u_suketpenghasilan.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="nik" name="nik" class="form-control" maxlength="16"  value="<?php echo $row ['nik']; ?>"  ></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" name="jmlhasil" id="jmlhasil" rows="3" value="<?php echo $dt[0]; ?>"class="form-control"><small class="form-text text-muted">Contoh : Rp. 5.000.000,-</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="sumberhasil" class=" form-control-label">Sumber Penghasilan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="sumberhasil" id="sumberhasil" rows="3" value="<?php echo $dt[1]; ?>" class="form-control"><small class="form-text text-muted">Contoh : Dari Pekerjaan sebagai Karyawan di PT. xxxxxxx</small></div>
                                    </div>
<hr>
                                    <div class="row form-group">
