        ...
        <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">EDIT SURAT KETERANGAN KEMATIAN
                            </h1>
                        </div>
                    ...
                    <form action="update/u_suketmati.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="bina" name="bina" value="<?php echo $dt[2]; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="pkjna" name="pkjna"value="<?php echo $dt[8]; ?>"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="alamata" class=" form-control-label">Alamat Alm./Almh.</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="alamata" name="alamata"  value="<?php echo $dt[9]; ?>"  class="form-control"><small class="form-text text-muted">Contoh : Rt. 001/Rw. 002</small></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="nik1" name="nik1" onkeyup="isinik1()" class="form-control" maxlength="16" value="<?php echo $dt[10]; ?>"  ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nama1" class=" form-control-label">Nama</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="nama1" name="nama1" value="<?php echo $dt[11]; ?>"class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="tmp_lahir1" name="tmp_lahir1" value="<?php echo $dt[13]; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tgl_lahir1" class=" form-control-label">Tanggal Lahir</label></div>
                                        <div class="col-12 col-md-4"><input type="text" id="tgl_lahir1" name="tgl_lahir1" value="<?php echo $dt[14]; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="pkjn1" name="pkjn1"value="<?php echo $dt[16]; ?>"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="alamat1" class=" form-control-label">Alamat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="alamat1" name="alamat1"  value="<?php echo $dt[17]; ?>" class="form-control"><small class="form-text text-muted">Contoh : Rt. 001/Rw. 002</small></div>
                                    </div>

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="shdk" class=" form-control-label">Hubungan dgn Alm./Almh.</label></div>
                                        <div class="col-12 col-md-4"><input type="text" id="shdk" name="shdk"  value="<?php echo $dt[18]; ?>" class="form-control"><small class="form-text text-muted">Contoh :Suami, Istri atau Anak</small></div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="sebab" name="sebab" value="<?php echo $dt[19]; ?>" class="form-control"><small class="form-text text-muted">Contoh : Sakit Hati</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="hari" class=" form-control-label">Hari</label></div>
                                        <div class="col-12 col-md-4"><select id="hari" name="hari" class="form-control">
                                            <option value="<?php echo $dt[20]; ?>" selected><?php echo $dt[20]; ?></option>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="tanggal" name="tanggal" value="<?php echo $dt[21]; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="waktu" class=" form-control-label">Waktu</label></div>
                                        <div class="col-12 col-md-4"><input type="text" id="waktu" name="waktu" value="<?php echo $dt[22]; ?>" class="form-control"><small class="form-text text-muted">Contoh : 18:00 WIB</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tempat" class=" form-control-label">Tempat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tempat" name="tempat"  value="<?php echo $dt[23]; ?>" class="form-control"><small class="form-text text-muted">Contoh : Rumah Sakit</small></div>
                                    </div>
