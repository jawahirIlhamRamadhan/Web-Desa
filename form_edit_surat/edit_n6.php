        ...
        <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">EDIT SURAT KETERANGAN KEMATIAN SUAMI/ISTRI (N6)
                            </h1>
                        </div>
...
<?php
            ...
            ?> 
                    <form action="update/u_n6.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="alamata" name="alamata"  value="<?php echo $dt[8]; ?>"  class="form-control"><small class="form-text text-muted">Contoh : Rt. 001/Rw. 002</small></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="nik1" name="nik1" onkeyup="isinik1()" class="form-control" maxlength="16" value="<?php echo $dt[9]; ?>"  ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nama1" class=" form-control-label">Nama</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="nama1" name="nama1" value="<?php echo $dt[10]; ?>"class="form-control"></div>
                                    </div>
                                     <div class="row form-group">
                                        <div class="col col-md-3"><label for="bin1" class=" form-control-label">Bin / Bnti</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="bin1" name="bin1" value="<?php echo $dt[11]; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="kwng1" name="kwng1"value="<?php echo $dt[15]; ?>"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4">
                                            <select name="hari" id="hari" class="form-control">
                                                <option value="<?php echo $dt[20]; ?>"  selected="selected"><?php echo $dt[20]; ?></option>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="date" id="tanggal" name="tanggal" value="<?php echo $dt[21]; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="waktu" class=" form-control-label">Waktu</label></div>
                                        <div class="col-12 col-md-4"><input type="time" id="waktu" name="waktu" value="<?php echo $dt[22]; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
