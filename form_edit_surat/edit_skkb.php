        ...
        <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">EDIT SURAT KETERANGAN KELAKUAN BAIK
                            </h1>
                        </div>
...
<?php
            ...
            ?> 
                    <form action="update/u_skkb.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="alamat" name="alamat"  value="<?php echo $dt[6]; ?>"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="untuk" class=" form-control-label">Peruntukan Surat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="untuk" name="untuk" value="<?php echo $dt[7]; ?>" class="form-control"><small class="form-text text-muted">Contoh : Mengurus/Membuat SKCK</small></div>
                                    </div>
                                    <hr>
                                    <div class="row form-group">
