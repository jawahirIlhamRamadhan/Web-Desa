    ...
    <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">EDIT SURAT PENGANTAR TERNAK
                            </h1>
                        </div>
...
<?php
            ...
            ?>
                                <form action="update/u_suketternak.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <hr>
                                   <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="nmternak" name="nmternak" class="form-control"  value="<?php echo $dt[0]; ?>" ><small class="form-text text-muted">Contoh : Sapi atau Kambing</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jnternak" class=" form-control-label">Jenis Ternak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="jnternak" name="jnternak" class="form-control"  value="<?php echo $dt[1]; ?>" ><small class="form-text text-muted">Contoh : Simental / Etawa</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="ciriternak" class=" form-control-label">Ciri - ciri Ternak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="ciriternak" name="ciriternak" class="form-control"  value="<?php echo $dt[2]; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="asalternak" class=" form-control-label">Asal Ternak/dari</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="asalternak" name="asalternak" class="form-control"  value="<?php echo $dt[4]; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tujuanternak" class=" form-control-label">Tujuan Ternak/dikirim ke</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tujuanbrg" name="tujuanternak" class="form-control"  value="<?php echo $dt[5]; ?>" ></div>
                                    </div>
