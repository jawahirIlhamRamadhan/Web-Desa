...
<body>
    <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-5">EDIT SURAT PEMBERITAHUAN
                            </h1>
 ...
 <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="perihal" name="perihal" value="<?php echo $dt[0]; ?>" class="form-control"><small class="form-text text-muted">Contoh : Jadwal Pembagian BLT bulan Januari 2023</small></div>
                                    </div>
                                    <div class="row form-group">
