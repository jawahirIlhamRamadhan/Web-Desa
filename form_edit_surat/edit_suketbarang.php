    ...
    <body>
            ...
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">EDIT SURAT PENGANTAR BARANG
                            </h1>
                        </div>
...
<?php
            ...
            ?>
                                <form action="update/u_suketbarang.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="nosurat" name="nosurat" readonly class="form-control" value="<?php echo $row ['no']; ?>" ></div>
                                </div>
                                ...
                                <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="nmbrg" name="nmbrg" class="form-control"  value="<?php echo $dt [0]; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jnbrg" class=" form-control-label">Jenis/Model</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="jnbrg" name="jnbrg" class="form-control"  value="<?php echo  $dt [1]; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jmlbrg" class=" form-control-label">Jumlah/Ukuran Barang</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="jmlbrg" name="jmlbrg" class="form-control"  value="<?php echo  $dt [2]; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="asalbrg" class=" form-control-label">Asal Barang/dari</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="asalbrg" name="asalbrg" class="form-control"  value="<?php echo  $dt [4]; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tujuanbrg" class=" form-control-label">Tujuan Barang/dikirim ke</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tujuanbrg" name="tujuanbrg" class="form-control"  value="<?php echo  $dt [5]; ?>" ></div>
                                    </div>
                                <hr>
