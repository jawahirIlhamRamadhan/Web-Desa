    ...
    <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-5">EDIT PERNYATAAN KESEPAKATAN GADAI TANAH
                            </h1>
...
<?php
            ...
            ?>
                                ...
                                <form action="update/u_gadai.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-3"><input type="number" id="harga_gadai" name="harga_gadai" value="<?php echo $dt[14]; ?>" required class="form-control"></div>
                                    </div>
                                <hr>
