...
<?php
 ...
 <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea rows="4" id="dasar" name="dasar" class="form-control"><?php echo $dt[2]; ?></textarea><small class="form-text text-muted">Contoh : Surat Camat Cikupa Nomor : 123, Tanggal 12 Mei 2023, Perihal Laporan Pencapaian Pembayaran Pajak Bumi dan Bangunan Tahun 2023</small></div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="lbg" name="lbg" value="<?php echo $dt[3]; ?>"  class="form-control"><small class="form-text text-muted">Contoh : Camat Cikupa</small></div>
                                    </div>
                                    <div class="row form-group">
