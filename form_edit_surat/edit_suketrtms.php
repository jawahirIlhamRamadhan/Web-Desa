        ...
        <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">EDIT SURAT KETERANGAN RUMAH TANGGA MISKIN
                            </h1>
                        </div>
...
<?php
            ...
            ?> 
                    <form action="update/u_suketrtms.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="tmp_lahir" name="tmp_lahir" value="<?php echo $dt[2];?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="niki" name="niki" onkeyup="isiniki()" class="form-control" maxlength="16"  value="<?php echo $dt[6];?>"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="namai" class=" form-control-label">Nama</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="namai" name="namai" value="<?php echo $dt[7];?>"class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
