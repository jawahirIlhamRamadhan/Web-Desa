        ...
        <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">EDIT SURAT KETERANGAN DOMISILI
                            </h1>
                        </div>
...
<?php
            ...
            ?> 
                    <form action="update/u_suketdomisili.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="sejak" name="sejak" value="<?php echo $dt[0]; ?>"   class="form-control"></div>
                                    </div>
