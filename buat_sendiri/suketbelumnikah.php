                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php
                                ...
                                <form action="save/s_suketbmenikah.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                        $query = mysqli_query ($con, "SELECT * FROM t_detailsurat, t_penduduk, t_buatsendiri WHERE t_detailsurat.kodejenis='JS021' AND t_detailsurat.nik='$nik' AND t_buatsendiri.nik=t_penduduk.nik AND t_detailsurat.kode=t_buatsendiri.kode_surat AND t_buatsendiri.status='acc' ORDER BY t_detailsurat.id DESC ");
                        $no=1;
