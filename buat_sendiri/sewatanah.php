                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php
                                ...
                                <form action="save/s_sewatanah.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                        $query = mysqli_query ($con, "SELECT * FROM t_buatsendiri, t_detailsurat WHERE t_buatsendiri.kode_jenis='JS034' AND t_buatsendiri.nik='$nik' AND t_buatsendiri.status='acc' AND t_detailsurat.kode=t_buatsendiri.kode_surat ORDER BY t_buatsendiri.id DESC ");
                            $no=1;
