    ...
    <div class="au-card recent-report">
             <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-5">SURAT KETERANGAN PINDAH
                            </h1>
                            ...
                            <?php
                                ...
                                <form action="save/s_sutarpindah.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM t_jenissurat WHERE kode='JS016' ORDER BY id ASC ");
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tujuan" name="tujuan"  placeholder="Isi dengan alamat tujuan pindah" class="form-control"><small class="form-text text-muted">Contoh : Desa Bitung Jaya Kec. Cikupa Kab. Tangerang</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jmlpindah" class=" form-control-label">Jumlah Keluarga yang Pindah</label></div>
                                        <div class="col-12 col-md-3"><input type="number" id="jmlpindah" name="jmlpindah"  placeholder="0" class="form-control"></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                        $query = mysqli_query ($con, "SELECT * FROM t_buatsendiri, t_detailsurat WHERE t_buatsendiri.kode_jenis='JS016' AND t_buatsendiri.nik='$nik' AND t_buatsendiri.status='acc' AND t_detailsurat.kode=t_buatsendiri.kode_surat ORDER BY t_buatsendiri.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td><?php echo $dt[3];?></td>
                                            <td>
                                                <a href="cetak/c_sutarpindah.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="?page=edit_sutarpindah&amp;kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
