    ...
    <div class="au-card recent-report">
              <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-5">SURAT KETERANGAN DOMISILI
                            </h1>
                            ...
                            <?php
                                ...
                                <form action="save/s_suketdomisili.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM t_jenissurat WHERE kode='JS015' ORDER BY id ASC ");
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="sejak" class=" form-control-label">Tinggal Sejak</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="sejak" name="sejak"  placeholder="Tanggal / tahun sejak tinggal" required class="form-control"><small class="form-text text-muted">Contoh : 12 Januari 2015</small></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                        $query = mysqli_query ($con, "SELECT * FROM t_buatsendiri, t_detailsurat, t_penduduk WHERE t_buatsendiri.kode_jenis='JS015' AND t_buatsendiri.nik='$nik' AND t_buatsendiri.status='acc' AND t_buatsendiri.nik=t_penduduk.nik AND t_detailsurat.kode=t_buatsendiri.kode_surat ORDER BY t_buatsendiri.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td><?php echo $dt[0];?></td>
                                            <td>
                                                <a href="cetak/c_suketdomisili.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="?page=edit_suketdomisili&amp;kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
