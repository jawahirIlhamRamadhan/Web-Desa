    ...
    <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-5">PERNYATAAN KESEPAKATAN GADAI TANAH
                            </h1>
                            ...
                            <?php
                                ...
                                <form action="save/s_gadai.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM t_jenissurat WHERE kode='JS036' ORDER BY id ASC ");
                                ...
                                <?php }}?>
                                <hr>
                                <h6 class="label">IDENTITAS PIHAK I (YANG MENGGADAIKAN)</h6>
                                <hr>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nik1" class=" form-control-label">NIK</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="nik1" name="nik1" onkeyup="isinik1()" class="form-control" maxlength="16"  placeholder="NIK Yang Menggadaikan" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nama1" class=" form-control-label">Nama</label></div>
                                        <div class="col-12 col-md-8"><input type="text" id="nama1" name="nama1" placeholder="Nama lengkap" class="form-control" required></div>
                                    </div>
                                     <div class="row form-group">
                                ...
                                <hr>
                                <hr>
                                <h6 class="label">IDENTITAS PIHAK II (YANG MENERIMA GADAI)</h6>
                                <hr>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nik2" class=" form-control-label">NIK</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="nik2" name="nik2" onkeyup="isinik2()" class="form-control" maxlength="16"  placeholder="NIK Penerima Gadai" required></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nama2" class=" form-control-label">Nama</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nama2" name="nama2" placeholder="Nama lengkap" required class="form-control"></div>
                                    </div>
                                     <div class="row form-group">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="harga_gadai" class=" form-control-label">Nilai Gadai (Rp.)</label></div>
                                        <div class="col-12 col-md-3"><input type="number" id="harga_gadai" name="harga_gadai" placeholder="0" required class="form-control"></div>
                                    </div>
                                <hr>
                                ...
                                <hr>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="barat" name="barat" placeholder="Batas sebelah Barat berbatasan dengan ?" required class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="utara" class=" form-control-label">Batas Utara</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="utara" name="utara" placeholder="Batas sebelah Utara berbatasan dengan ?" required class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="timur" class=" form-control-label">Batas Timur</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="timur" name="timur" placeholder="Batas sebelah Timur berbatasan dengan ?" required class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="selatan" class=" form-control-label">Batas Selatan</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="selatan" name="selatan" placeholder="Batas sebelah Selatan berbatasan dengan ?" required class="form-control"></div>
                                    </div>
                                    <hr>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                        $query = mysqli_query ($con, "SELECT * FROM t_buatsendiri, t_detailsurat WHERE t_buatsendiri.kode_jenis='JS036' AND t_buatsendiri.nik='$nik' AND t_buatsendiri.status='acc' AND t_detailsurat.kode=t_buatsendiri.kode_surat ORDER BY t_buatsendiri.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="cetak/c_gadai.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="?page=edit_gadai&amp;kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
