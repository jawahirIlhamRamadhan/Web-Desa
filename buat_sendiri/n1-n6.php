        ...
        <div class="card-body">
            <div class="custom-tab">
                            ...
                            <?php
                                ...
                                <form action="save/s_sutarnikah.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                        $query = mysqli_query ($con, "SELECT * FROM t_detailsurat, t_penduduk, t_buatsendiri WHERE t_detailsurat.kodejenis='JS019' AND t_detailsurat.nik='$nik' AND t_buatsendiri.nik=t_penduduk.nik AND t_detailsurat.kode=t_buatsendiri.kode_surat AND t_buatsendiri.status='acc' ORDER BY t_detailsurat.id DESC ");
                        $no=1;
                        while ($data = mysqli_fetch_assoc($query)){
                         ?>
                                        <tr>
                                            ...
                                            <a href="del/h_detailsurat.php?kode=<?php echo $r['kode'];?>" class="btn"><i class="fa fa-trash"></i></a></td>
                                        </tr>
                                       <?php }?>
                                    </tbody>
                                </table>
