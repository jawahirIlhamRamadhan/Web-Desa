    ...
    <!-- Left Panel -->
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-5">SURAT PERMOHOAN KTP
                            </h1>
                            ...
                            <?php
                                ...
                                <form action="save/s_f121.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM t_jenissurat WHERE kode='JS032' ORDER BY id ASC ");
                                ...
                                <?php }}?>
                                <hr>
                                <h6 class="label">JENIS PERMOHONAN KTP</h6>
                                <hr>
                                <div class="row form-group">
                                        <div class="col col-md-3"><label for="jp" class=" form-control-label">Jenis Permohonan</label></div>
                                        <div class="col-12 col-md-9">

                                        <div class="icheck-primary d-inline pull-left">
                                            <input type="radio" id="jp1" name="jp" value="A">
                                            <label for="jp1">A. Baru
                                            </label>&nbsp;&nbsp;&nbsp;
                                            <input type="radio" id="jp2" name="jp" value="B">
                                            <label for="jp2">B. Perpanjangan
                                            </label>&nbsp;&nbsp;&nbsp;
                                            <input type="radio" id="jp3" name="jp" value="C">
                                            <label for="jp3">C. Pergantian
                                            </label>
                                          </div>
                                        </div>
                                    </div>
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="nkk" name="nkk" class="form-control" maxlength="16" readonly="readonly" placeholder="Nomor Kartu Keluarga"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="almt" name="almt" placeholder="Kp. Pulo, RT/RW.011/005" class="form-control"><small class="form-text text-muted">Contoh : Kp. Pulo, RT/RW.011/005</small></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                       <?php 
                        $query = mysqli_query ($con, "SELECT * FROM t_detailsurat, t_penduduk, t_buatsendiri WHERE t_detailsurat.kodejenis='JS032' AND t_detailsurat.nik='$nik' AND t_buatsendiri.nik=t_penduduk.nik AND t_detailsurat.kode=t_buatsendiri.kode_surat AND t_buatsendiri.status='acc' ORDER BY t_detailsurat.id DESC ");
                        $no=1;
                        while ($data = mysqli_fetch_assoc($query)){
                            $jp=explode(';',$data['detail']);
                         ?>
                                        <tr>
                                            <td><?php echo $no++;?></td>
                                            ...
                                            <td><input type="radio" id="jp1" name="jp" value="A" <?php if (in_array("A", $jp)) echo "checked";?>>&nbsp;A &nbsp;<br><input type="radio" id="jp2" name="jp" value="B" <?php if (in_array("B", $jp)) echo "checked";?>>&nbsp;B &nbsp; <br><input type="radio" id="jp3" name="jp" value="C" <?php if (in_array("C", $jp)) echo "checked";?>> C</td>
                                            <td>
                                                <a href="cetak/c_f121.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="?page=edit_f121&amp;kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
