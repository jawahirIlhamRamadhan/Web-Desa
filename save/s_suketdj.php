...
mysqli_query($con, "INSERT INTO t_detailsurat (kode, kodejenis, nmsurat, no, nik, nama, detail, tanggal, ttd, qrcode, id_ptg) values('$kode','$kodejenis','$nmsurat','$nosur','$nik','$nama', 'Duda/janda','".date('Y-m-d')."','$kades','".$nama_qr.".png','$idstf')");
