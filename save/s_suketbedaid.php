...
mysqli_query($con, "INSERT INTO t_buatsendiri (nik, nama, kode_surat, kode_jenis, no_surat, nmsurat, tgl, status) VALUES ('$nik1','$nama1','$kode','$kodejenis','$nosur','$nmsurat','".date('Y-m-d')."','onprocess')");
