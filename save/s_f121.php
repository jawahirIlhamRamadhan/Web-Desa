...
mysqli_query($con, "INSERT INTO t_buatsendiri (nik, nama, kode_surat, kode_jenis, no_surat, nmsurat, tgl, status) VALUES ('$nik','$nm','$kode','$kodejenis','$nosur','$nmsurat','".date('Y-m-d')."','onprocess')");
...
mysqli_query($con, "INSERT INTO t_detailsurat (kode, kodejenis, nmsurat, no, nik, nama, detail, tanggal, ttd, qrcode, id_ptg) values('$kode','$kodejenis','$nmsurat','$nosur','$nik','$nm', '$jp','".date('Y-m-d')."','$kades','".$nama_qr.".png','$idstf')");
