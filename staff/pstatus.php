    ...
    <div class="au-card recent-report">
             <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-5">SURAT PERNYATAAN STATUS
                            </h1>
                            ...
                            <?php
                                ...
                                $nosurat = sprintf("%03s", $urutan);
                                ?>

                                <form action="act/s_pstatus.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM t_jenissurat WHERE kode='JS098' ORDER BY id ASC ");
                                    ...
                                    <div class="row form-group">
                                        <div class="col-12 col-md-9"><input type="hidden" id="nosurat" name="nosurat" class="form-control" value="<?php echo $nosurat ?>"></div>
                                ...
                                <?php }}?>
                                <h6>IDENTITAS PEMBUAT PERNYATAAN :</h6>
                                <hr>
                                    <div class="row form-group">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_detailsurat.*, t_penduduk.* FROM t_detailsurat, t_penduduk WHERE t_detailsurat.kodejenis='JS098' AND t_detailsurat.nik=t_penduduk.nik AND t_detailsurat.id_ptg='$idstf' ORDER BY t_detailsurat.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="cetak/c_pstatus.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="?page=edit_pstatus&amp;kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
                                                <a href="hapus/h_pstatus.php?kode=<?php echo $data['kode'];?>" class="btn"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
