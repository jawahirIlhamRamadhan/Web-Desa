                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_n8.*, t_sutarnikah.* FROM t_n8, t_sutarnikah WHERE t_n8.kode=t_sutarnikah.kode  ORDER BY t_n8.id DESC ");
                            while ($r = mysqli_fetch_array($query)){
                                $no=1;
                         ?>
                                        <tr>
                                            ...
                                            <td><?php echo $r['hari'];?>, <?php echo $r['tgl_akad'];?></td>
                                            <td><?php echo $r['waktu'];?></td>
                                            <td><?php echo $r['tmpt'];?></td>
                                            <td><a href="../cetak/c_n8.php?kode=<?php echo $r['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a><a href="../edit/edit_n8.php?kode=<?php echo $r['kode'];?>" class="btn"><i class="fa fa-edit"></i></a>
                                            <a href="../hapus/h_n8.php?kode=<?php echo $r['kode'];?>" class="btn"><i class="fa fa-trash"></i></a></td>
                                        </tr>
                                       <?php }?>
                                    </tbody>
                                </table>
...
<div class="popup-wrapper" id="popup">
    <div class="popup-container"> 
        <a class="popup-close" href="../cetak/c_sutarnikah.php?kode=<?php echo $row['kode'];?>"><span aria-hidden="true">&times;</span></a>                              
            <div class="modal-header">
                <h5 class="modal-title" id="mediumModalLabel">FORMULIR PEMERIKSAAN NIKAH</h5>
            </div>
        <div class="input-group ">
        <div class="col-md-12">

                        <form action="../simpan/s_n8.php"  method="post" onsubmit="return validasi_input(this)"  enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                <div class="row form-group">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="hari" id="hari" class="form-control">
                                                <option value="-" readonly selected="selected">Hari</option>
                                                <option value="Senin">Senin</option>
                                                <option value="Selasa">Selasa</option>
                                                <option value="Rabu">Rabu</option>
                                                <option value="Kamis">Kamis</option>
