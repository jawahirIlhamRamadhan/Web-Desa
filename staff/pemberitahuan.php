...
<hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea rows="6" id="detail" name="detail" placeholder="Contoh : Meneruskan hasil komunikasi dengan Ka. UPT PUSKESMAS Kecamatan Cikupa kami beritahukan kepada Bapak RT dan Kadus bahwa Jadwal Vaksinasi Dosis 3 / Booster dimajukan yang semula tanggal 12 April 2023 menjadi tanggal 10 April 2023, untuk itu mohon sampaikan kepada warganya dilingkungan masing- masing." class="form-control" required></textarea></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM t_detailsurat WHERE kodejenis='JS027' AND t_detailsurat.id_ptg='$idstf' ORDER BY id ASC ");
                            $no=1;
