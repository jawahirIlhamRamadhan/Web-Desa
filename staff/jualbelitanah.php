    ...
    <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-5">PERNYATAAN KESEPAKATAN JUAL BELI TANAH
                            </h1>
                            ...
                            <?php
                                ...
                                <form action="act/s_jualbelitanah.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM t_jenissurat WHERE kode='JS035' ORDER BY id ASC ");
                                ...
                                <?php }}?>
                                <hr>
                                <h6 class="label">IDENTITAS PIHAK I (YANG MENJUAL)</h6>
                                <hr>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nik1" class=" form-control-label">NIK</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="nik1" name="nik1" onkeyup="isinik1()" class="form-control" maxlength="16"  placeholder="NIK Penjual" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nama1" class=" form-control-label">Nama</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nama1" name="nama1" placeholder="Nama Penjual" class="form-control" required></div>
                                    </div>
                                     <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tmplahir1" name="tmplahir1" placeholder="Tempat lahir" class="form-control" required></div>
                                    </div>
                                    <div class="row form-group">
                                ...
                                <hr>
                                <hr>
                                <h6 class="label">IDENTITAS PIHAK II (YANG MEMBELI)</h6>
                                <hr>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nik2" class=" form-control-label">NIK</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="nik2" name="nik2" onkeyup="isinik2()" class="form-control" maxlength="16"  placeholder="NIK Pembeli" required ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nama2" class=" form-control-label">Nama</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nama2" name="nama2" placeholder="Nama Pembeli" class="form-control" required></div>
                                    </div>
                                     <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tmplahir2" name="tmplahir2" placeholder="Tempat lahir" class="form-control" required></div>
                                    </div>
                                    <div class="row form-group">
                                     ...
                                     <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="almt2" name="almt2" placeholder="Alamat lengkap" required class="form-control"></div>
                                    </div>
                                <hr>
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="harga" class=" form-control-label">Harga Tanah (Rp.)</label></div>
                                        <div class="col-12 col-md-3"><input type="number" id="harga" name="harga" placeholder="0" required class="form-control"></div>
                                    </div>
                                <hr>
                                ...
                                <hr>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="barat" name="barat" placeholder="Batas sebelah Barat berbatasan dengan ?" required class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="utara" class=" form-control-label">Batas Utara</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="utara" name="utara" placeholder="Batas sebelah Utara berbatasan dengan ?" required class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="timur" class=" form-control-label">Batas Timur</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="timur" name="timur" placeholder="Batas sebelah Timur berbatasan dengan ?" required class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="selatan" class=" form-control-label">Batas Selatan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="selatan" name="selatan" placeholder="Batas sebelah Selatan berbatasan dengan ?" required class="form-control"></div>
                                    </div>
                                    <hr>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM t_detailsurat WHERE t_detailsurat.kodejenis='JS035' AND t_detailsurat.id_ptg='$idstf' ORDER BY t_detailsurat.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td><?php echo $dt[1];?></td>
                                            <td><?php echo $dt[7];?></td>
                                            <td><?php echo format_angka($dt[12]);?> Ha./M2 - Rp. <?php echo format_angka($dt[14]);?></td>
                                            
                                            <td>
                                                <a href="cetak/c_jualbelitanah.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="?page=edit_jualbelitanah&amp;kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
                                                <a href="hapus/h_jualbelitanah.php?kode=<?php echo $data['kode'];?>" class="btn"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
