    ...
    <div class="au-card recent-report">
               <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-5">SURAT KETERANGAN BEPERGIAN
                            </h1>
                            ...
                            <?php
                                ...
                                <form action="act/s_suketbepergian.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM t_jenissurat WHERE kode='JS013' ORDER BY id ASC ");
                                ...
                                <hr>
                                <h6>KETERANGAN YANG AKAN BEPERGIAN</h6>
                                <hr>
                                    <div class="row form-group">
                                ...
                                <hr>
                                <h6> KETERANGAN TUJUAN</h6>
                                <hr>
                                   <div class="row form-group">
                                        <div class="col col-md-3"><label for="tujuan" class=" form-control-label">Tujuan </label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tujuan" name="tujuan" class="form-control"  placeholder="Kota tujuan bepergian" required><small class="form-text text-muted">Contoh : Kota Jakarta</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="keg" class=" form-control-label">Dalam rangka / Kegiatan </label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="keg" name="keg" class="form-control" required placeholder="Kegiatan yang akan di lakukan" ><small class="form-text text-muted">Contoh : Bekerja</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tgl" class=" form-control-label">Tanggal Keberangkatan</label></div>
                                        <div class="col-12 col-md-4"><input type="text" id="tgl" name="tgl" class="form-control" required placeholder="Tanggal keberangkatan" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="brg" class=" form-control-label">Barang yang dibawa</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="brg" name="brg" class="form-control" required placeholder="Jenis atau Nama Barang yang dibawa" ><small class="form-text text-muted">Contoh : Pakaian ganti</small></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM t_detailsurat WHERE t_detailsurat.kodejenis='JS013' AND t_detailsurat.id_ptg='$idstf' ORDER BY t_detailsurat.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td><?php echo $dt[1];?></td>
                                            <td>
                                                <a href="cetak/c_suketbepergian.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="?page=edit_suketbepergian&amp;kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
                                                <a href="hapus/h_suketbepergian.php?kode=<?php echo $data['kode'];?>" class="btn"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
