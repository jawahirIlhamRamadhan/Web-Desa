    ...
    <div class="au-card recent-report">
             <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-5">SURAT PENGANTAR
                            </h1>
            ...
            <div class="card-body card-block">
                        ...
                        <form action="act/s_pengantar.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM t_jenissurat WHERE kode='JS026' ORDER BY id ASC ");
...
<hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="objek" name="objek" placeholder="Isi dengan perihal yang akan disampaikan / dikirim" class="form-control"><small class="form-text text-muted">Contoh : Laporan Penduduk Bulan Mei 2023</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="banyak" class=" form-control-label">Lampiran</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="banyak" name="banyak" placeholder="Isi dengan jumlah lampiran"  class="form-control"><small class="form-text text-muted">Contoh : 1 Bundel</small></div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea id="dasar" name="dasar" rows="3" placeholder="Isi dengan dasar surat terkait " class="form-control"></textarea><small class="form-text text-muted">Contoh : Surat Camat Cikupa Nomor : 123, Tanggal 12 Mei 2023, Perihal Laporan Penduduk Bulan Mei 2023</small></div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="lbg" name="lbg" placeholder="Isi dengan Nama / Lembaga yang dituju"  class="form-control"><small class="form-text text-muted">Contoh : Camat Cikupa</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="almt" class=" form-control-label">Alamat yang dituju</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="almt" name="almt"  placeholder="Isi dengan Alamat yang dituju" class="form-control"></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM t_detailsurat WHERE kodejenis='JS026' AND t_detailsurat.id_ptg='$idstf' ORDER BY id ASC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td><?php echo $dt[3];?></td>
                                            <td>
                                                <a href="cetak/c_pengantar.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="?page=edit_pengantar&amp;kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
                                                <a href="hapus/h_pengantar.php?kode=<?php echo $data['kode'];?>" class="btn"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
