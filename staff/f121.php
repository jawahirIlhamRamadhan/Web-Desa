                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_penduduk.*, t_detailsurat.* FROM t_penduduk, t_detailsurat WHERE t_penduduk.nik=t_detailsurat.nik AND  kodejenis='JS032' AND t_detailsurat.id_ptg='$idstf' ORDER BY t_detailsurat.id DESC ");
                            $no=1;
