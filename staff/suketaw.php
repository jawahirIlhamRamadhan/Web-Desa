                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_detailsurat.* FROM t_detailsurat WHERE t_detailsurat.kodejenis='JS023' AND t_detailsurat.id_ptg='$idstf' ORDER BY t_detailsurat.id DESC ");
                            $no=1;
                            while ($r = mysqli_fetch_array($query)){
                                $dt=explode(';', $r['detail']);
