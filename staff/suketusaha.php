...
<div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="title-5">SURAT KETERANGAN USAHA
                            </h1>
                        </div>
...
<!-- MODAL SURAT KETERANGAN UMUM -->
                            ...
                            <?php
                                ...
                                <form action="act/s_suketusaha.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM t_jenissurat WHERE kode='JS001' ORDER BY id ASC ");
                                ...
                                <hr>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="nik" name="nik" onkeyup="isinik()" class="form-control" maxlength="16"  placeholder=" NIK Pemohon" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nama" class=" form-control-label">Nama</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nama" name="nama" placeholder="Nama Pemohon" readonly="readonly" class="form-control" required></div>
                                    </div>
                                    
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jnusaha" class=" form-control-label">Jenis / Bidang Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="jnusaha" name="jnusaha" placeholder="Jenis atau Bidang Usaha yang dijalani"  class="form-control" required></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="mulaiusaha" class=" form-control-label">Berjalan Sejak</label></div>
                                        <div class="col-12 col-md-4"><input type="text" id="mulaiusaha" name="mulaiusaha" placeholder="Tgl, Bln atau Thn"  class="form-control" required></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="lokusaha" class=" form-control-label">Alamat / Lokasi Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="lokusaha" name="lokusaha" placeholder="Alamat atau lokasi tempat Usaha"  class="form-control" required></div>
                                    </div>
...
<!-- END MODAL SUKET UMUM -->
                ...
                <div class="row animated fadeIn tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM t_detailsurat, t_penduduk WHERE t_detailsurat.kodejenis='JS001' AND t_penduduk.nik=t_detailsurat.nik AND t_detailsurat.id_ptg='$idstf'  ORDER BY t_detailsurat.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td><?php echo $dt[0];?></td>
                                            <td>
                                                <a href="cetak/c_suketusaha.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="?page=edit_suketusaha&amp;kode=<?php echo $data['kode'];?>" class="btn"><i class="fa fa-edit"></i></a>
                                                <a href="hapus/h_suketusaha.php?kode=<?php echo $data['kode'];?>" class="btn"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
