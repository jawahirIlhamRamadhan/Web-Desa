...
<div class="card-body card-block">
                                ...
                                ?>
                                <form action="act/s_n6.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM t_detailsurat WHERE kodejenis='JS038' AND t_detailsurat.id_ptg='$idstf' ORDER BY id DESC ");
                            while ($r = mysqli_fetch_array($query)){
                                $dt=explode(';', $r['detail']);
                         ?>
                                        <tr>
                                            ...
                                            <td><?php echo $dt[1];?></td>
                                            <td><a href="cetak/c_n6.php?kode=<?php echo $r['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a><a href="?page=edit_n6&amp;kode=<?php echo $r['kode'];?>" class="btn"><i class="fa fa-edit"></i></a><a href="hapus/h_suketmati.php?kode=<?php echo $r['kode'];?>" class="btn"><i class="fa fa-trash"></i></a></td>
                                        </tr>
                                       <?php }?>
                                    </tbody>
                                </table>
