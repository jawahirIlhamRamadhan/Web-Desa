    ...
    <div class="au-card recent-report">
            ...
            <div class="card-body card-block">
                            <?php
                                ...
                                <form action="act/s_suketlain.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM t_detailsurat WHERE kodejenis='JS099' AND t_detailsurat.id_ptg='$idstf' ORDER BY id ASC ");
                            $no=1;
